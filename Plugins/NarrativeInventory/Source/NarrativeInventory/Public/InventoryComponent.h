...
public:
	...
	UPROPERTY(BlueprintReadOnly, Category = "Item Add Result")
	TArray<TObjectPtr<class UNarrativeItem>> Stacks = {};
	...
	static FItemAddResult AddedSome(TArray<class UNarrativeItem*> InItems, const int32 InItemQuantity, const int32 ActualAmountGiven, const FText& ErrorText)
	{
		...
		AddedSomeResult.Stacks = TArray<TObjectPtr<class UNarrativeItem>>(InItems);
	...
	static FItemAddResult AddedAll(TArray<class UNarrativeItem*> InItems, const int32 InItemQuantity)
	{
		...
		AddAllResult.Stacks = TArray<TObjectPtr<class UNarrativeItem>>(InItems);
...
public:
	...
	UFUNCTION(BlueprintPure, Category = "Inventory")
	FORCEINLINE TArray<class UNarrativeItem*> GetItems() const { return TArray<UNarrativeItem*>(Items); }
